...
void _ASDUSBInterfaceReadWriteAsyncCallback(void *refcon, IOReturn result, void *arg0);
...
-(BOOL)readFromPipeAsync:(UInt8)pipe callback:(LTIOUSBDeviceReadCallback)callback maxPacketSize:(UInt32)maxSize noDataTimeout:(UInt32)dto completionTimeout:(UInt32)cto
{
    ...
    IOReturn ret = (*interface)->ReadPipeAsyncTO(interface, pipe, buffer, maxSize, dto, cto, _ASDUSBInterfaceReadWriteAsyncCallback, (void*)readCallBack);
...
-(BOOL)writeToPipeAsync:(UInt8)pipe data:(NSData *)data callback:(LTIOUSBDeviceWriteCallback)callback noDataTimeout:(UInt32)dto completionTimeout:(UInt32)cto
{
    ...
    IOReturn ret = (*interface)->WritePipeAsyncTO(interface, pipe, (void*)data.bytes, (UInt32)data.length, dto, cto, _ASDUSBInterfaceReadWriteAsyncCallback, (void*)writeCallBack);
...
@implementation ASDIOUSBDevice(Private)
